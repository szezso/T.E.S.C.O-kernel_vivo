...
#define PANEL_ID_GOLFU_AUO    (0x54 | BL_MIPI | IF_MIPI | DEPTH_RGB666)
#define PANEL_ID_GOLFU_AUO_C2    (0x54 | BL_MIPI | IF_MIPI | DEPTH_RGB666 | REV_1)
#define PANEL_ID_GOLFU_AUO_C3    (0x54 | BL_MIPI | IF_MIPI | DEPTH_RGB666 | REV_2)
#define PANEL_ID_GOLFU_AUO_C4    (0x54 | BL_MIPI | IF_MIPI | DEPTH_RGB666 | REV_3)
...
#define PANEL_ID_GOLFC_AUO (0x5B | BL_MDDI | IF_MIPI | DEPTH_RGB666)
#define PANEL_ID_GOLFC_AUO_C2 (0x5B | BL_MDDI | IF_MIPI | DEPTH_RGB666 | REV_1)
