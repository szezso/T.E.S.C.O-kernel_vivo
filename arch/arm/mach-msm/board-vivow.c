...
unsigned int vivow_get_engineerid(void)
{
	return engineerid;
}
...
static struct i2c_board_info i2c_devices[] = {
	{
		...
		.irq = PM8058_GPIO_IRQ(PM8058_IRQ_BASE, VIVOW_GPIO_TP_INT_N)
	},
};
...
static struct i2c_board_info i2c_Sensors_devices[] = {
	{
		...
		.irq = PM8058_GPIO_IRQ(PM8058_IRQ_BASE, VIVOW_GPIO_COMPASS_INT_N),
	},
	{
...
static int pm8058_gpios_init(void)
{
	...
	struct pm8xxx_gpio_init_info gpio19 = {
		PM8058_GPIO_PM_TO_SYS(VIVOW_AUD_AMP_EN),
		{
			.direction      = PM_GPIO_DIR_OUT,
			.output_buffer  = PM_GPIO_OUT_BUF_CMOS,
			.output_value   = 0,
	...
	struct pm8xxx_gpio_init_info gpio24 = {
		PM8058_GPIO_PM_TO_SYS(VIVOW_GREEN_LED),
		{
			.direction      = PM_GPIO_DIR_OUT,
			.output_buffer  = PM_GPIO_OUT_BUF_CMOS,
			.output_value   = 1,
	...
	struct pm8xxx_gpio_init_info gpio25 = {
		PM8058_GPIO_PM_TO_SYS(VIVOW_AMBER_LED),
		{
			.direction      = PM_GPIO_DIR_OUT,
			.output_buffer  = PM_GPIO_OUT_BUF_CMOS,
			.output_value   = 1,
...
static struct pm8xxx_irq_platform_data pm8xxx_irq_pdata = {
	...
	.devirq			= MSM_GPIO_TO_INT(VIVOW_PMIC_GPIO_INT),
...
static struct msm_ssbi_platform_data msm7x30_ssbi_pm8058_pdata __devinitdata = {
	...
	.slave	= {
		.name			= "pm8058-core",
		.irq = MSM_GPIO_TO_INT(VIVOW_PMIC_GPIO_INT),
...
static struct tps65200_platform_data tps65200_data = {
	.gpio_chg_int = MSM_GPIO_TO_INT(PM8058_GPIO_PM_TO_SYS(VIVOW_GPIO_CHG_INT)),
};
...
#ifdef CONFIG_S5K3H1GX
static int vivow_s5k3h1gx_vreg_on(void)
{
  int rc;
...
static int vivow_s5k3h1gx_vreg_off(void)
{
  int rc;
...
#ifdef CONFIG_S5K6AAFX
static int vivow_s5k6aafx_vreg_on(void)
{
  int rc;
  pr_info("%s camera vreg on\n", __func__);
...
static int vivow_s5k6aafx_vreg_off(void)
{
  int rc;
  pr_info("%s camera vreg off\n", __func__);
...
#ifdef CONFIG_S5K3H1GX
static void vivow_maincam_clk_switch(void){
	int rc = 0;
...
#ifdef CONFIG_S5K6AAFX
static void vivow_seccam_clk_switch(void){
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k6aafx_data = {
	...
	.sensor_pwd = CAM2_PWD,
	.camera_power_on = vivow_s5k6aafx_vreg_on,
	.camera_power_off = vivow_s5k6aafx_vreg_off,
	.camera_clk_switch = vivow_seccam_clk_switch,
	.pdata = &camera_device_data,
	.flash_type = MSM_CAMERA_FLASH_LED,
	.resource = msm_camera_resources,
	.num_resources = ARRAY_SIZE(msm_camera_resources),
...
{
	if (gpio_tlmm_config(GPIO_CFG(VIVOW_PMIC_GPIO_INT, 1, GPIO_CFG_INPUT,
				  GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE))
		pr_err("%s: gpio_tlmm_config (gpio=%d) failed\n",
		       __func__, VIVOW_PMIC_GPIO_INT);
...
static void __init vivow_init_marimba(void)
{
...
static struct cable_detect_platform_data cable_detect_pdata = {
	...
	.usb_id_pin_gpio 	= VIVOW_GPIO_USB_ID_PIN,
	.config_usb_id_gpios 	= config_vivow_usb_id_gpios,
	.get_adc_cb		= vivow_get_usbid_adc,
};
...
static struct htc_sleep_clk_platform_data htc_slp_clk_data = {
	.sleep_clk_pin = VIVOW_GPIO_WIFI_BT_SLEEP_CLK_EN,
...
static void __init vivow_init_irq(void)
{
	msm_init_irq();
}
...
static int mbp_config_interfvivow_mode(int state)
{
	if (state) {
...
static int mbp_power_up(void)
{
	...
	udelay(300);
	rc = mbp_config_interfvivow_mode(MBP_ON);
	if (rc)
		goto exit;
	pr_debug("%s: mbp_config_interfvivow_mode() done\n", __func__);
...
static unsigned int vivow_sdc2_slot_type = MMC_TYPE_MMC;
static struct mmc_platform_data msm7x30_sdc2_data = {
	...
	.slot_type		= &vivow_sdc2_slot_type,
	.nonremovable	= 1,
};
#endif
...
/* HTC_WIFI_START */
/*
static unsigned int vivow_sdc3_slot_type = MMC_TYPE_SDIO_WIFI;
static struct mmc_platform_data msm7x30_sdc3_data = {
	...
	.msmsdcc_fmid	= 24576000,
	.msmsdcc_fmax	= 49152000,
	.slot_type		= &vivow_sdc3_slot_type,
	.nonremovable	= 0,
};
* */
/* HTC_WIFI_END */
...
#ifdef CONFIG_MMC_MSM_SDC4_SUPPORT
static unsigned int vivow_sdc4_slot_type = MMC_TYPE_SD;
static struct mmc_platform_data msm7x30_sdc4_data = {
	...
	.status_irq  = PM8058_GPIO_IRQ(PMIC8058_IRQ_BASE, VIVOW_GPIO_SDMC_CD_N),
	...
	.msmsdcc_fmax	= 50000000,
	.nonremovable	= 0,
	.slot_type     = &vivow_sdc4_slot_type,
};
#endif
...
static void __init vivow_reserve(void)
{
...
static void __init vivow_init_early(void)
{
	vivow_allocate_memory_regions();
}
...
MACHINE_START(VIVOW, "vivow")
	.fixup = vivow_fixup,
	.map_io = vivow_map_io,
	.reserve = vivow_reserve,
	.init_irq = vivow_init_irq,
	.init_machine = vivow_init,
	.timer = &msm_timer,
	.init_early = vivow_init_early,
MACHINE_END
