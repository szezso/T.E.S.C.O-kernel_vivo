...
struct smd_channel {
	...
	char name[32];	/* Modified by Andy for SMD upper layer drivers */
...
static int smd_alloc_channel(struct smd_alloc_elm *alloc_elm)
{
	...
	/* Modified by Andy for HTC SMD upper layer drivers */
	/*=============================================*/
	if (ch->type == SMD_APPS_MODEM)
...
/* Added by Andy for HTC /drivers/net/msm_rmnet.c */
/* ========================================================================*/
...
{
	return smd_tiocmset(ch, set, clear);
}
...
/* Added by Andy for HTC /arch/arm/mach-msm/pm.c */
/* ========================================================================*/
...
static int __devinit msm_smd_probe(struct platform_device *pdev)
{
	...
	msm_check_for_modem_crash = smsm_check_for_modem_crash;
