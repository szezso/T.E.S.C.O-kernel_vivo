...
#ifdef DEBUG
#define DEV_DBG(args...)	pr_info("[DISP]HDMI: " args)
#else
#define DEV_DBG(args...)	(void)0
#endif /* DEBUG */
#define DEV_INFO(args...)	dev_info(hdmi_common_state->dev, "[DISP]"args)
#define DEV_WARN(args...)	dev_warn(hdmi_common_state->dev, "[DISP]"args)
#define DEV_ERR(args...)	dev_err(hdmi_common_state->dev, "[DISP]"args)
